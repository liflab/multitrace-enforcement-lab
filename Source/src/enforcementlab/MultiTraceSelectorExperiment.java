...
import ca.uqac.lif.cep.enforcement.AppendToMultiTrace;
...
import ca.uqac.lif.cep.enforcement.WrapEvent;
...
public class MultiTraceSelectorExperiment extends Experiment
{
	...
	public void execute() throws ExperimentException, InterruptedException
	{
		...
		Proxy atm = new Proxy(new ApplyFunction(WrapEvent.instance));
		...
		while (q_p.hasNext())
		{
			...
			List<PrefixTreeElement> l_mte = (List<PrefixTreeElement>) q_p.pull();
			s_p.push(l_mte);
		}
