...
/**
 * A sequence of multi-events.
 */
public class MultiTraceElement extends ArrayList<MultiEvent>
{
	 ...
	 */
	public MultiTraceElement(MultiEvent ... events)
	{
		super();
	 ...
	 * @param events The multi-events
	 */
	public MultiTraceElement(Collection<MultiEvent> events)
	{
		super();
		for (MultiEvent e : events)
		{
