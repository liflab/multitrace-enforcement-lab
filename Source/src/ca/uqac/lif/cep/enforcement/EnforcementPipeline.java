 ...
 * comprising:
 * <ol>
 * <li>A {@link Proxy}, which takes a trace of events and produces a
 * multi-trace</li>
 * <li>A {@link Filter}, which filters the multi-trace based on the
 * verdict produced by an underlying monitor</li>
 * <li>A {@link Selector}, which periodically evaluates these
...
public class EnforcementPipeline extends GroupProcessor
{
	 ...
	 * @param monitor The filter evaluating a property on uni-traces
	 * @param scorer The scoring processor producing an integer score on
	 * uni-traces
	 */
	public EnforcementPipeline(Proxy proxy, Filter filter, Selector scorer)
	{
		super(1, 1);
		m_proxy = proxy;
		m_filter = filter;
