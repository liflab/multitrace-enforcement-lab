...
import multitrace.BruteForceMultiTraceSelector;
...
public class MultiTraceSelectorExperimentFactory extends ExperimentFactory<MainLab,MultiTraceSelectorExperiment>
{
	 ...
	 */
	protected MultiTraceProvider m_traceProvider;
	 ...
	 */
	public MultiTraceSelectorExperimentFactory(MainLab lab, MultiTraceProvider traces, ScoringProcessorProvider scores)
	{
